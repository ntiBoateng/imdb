...
const About = () => {
  return (
    <div className='max-w-6xl mx-auto space-y-4 p-4'>
        ...
        <p>
        Our journey began with a shared love for the silver screen and a desire to create a space where fellow movie lovers could indulge their passion. We believe that movies have the power to transport us, inspire us, and spark meaningful conversations. With that in mind, we set out to curate a collection of engaging content that caters to all types of movie enthusiasts.
        </p>
...
The <span className='text-md text-amber-500 font-medium'>IMDB</span> Team
        </p>
    </div>
  )
}
