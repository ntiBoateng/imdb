...
const MoviePage = async({params}) => {
  ...
  return (
    <div className='w-full'>
        ...
        <Image style={{maxWidth:"100%",height:"100%"}} width={500} height={300} placeholder='blur' alt='image not available' blurDataURL='spinner.svg' className='rounded:lg' src={`https://image.tmdb.org/t/p/original/${movie.backdrop_path || movie.post_path}`}></Image>
        <div className="p-2">
